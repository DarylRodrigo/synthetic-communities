...
export async function interpretFiltersWithAI(query, availableOptions) {
  ...
  const filterSchema = {
    ...
    required: ['demographics', 'geographic', 'cultural']
  };
...
export async function interpretDistributionWithAI(query, availableOptions) {
  ...
  const distributionSchema = {
    ...
    required: ['sampleSize', 'gender', 'ageGroups', 'religion', 'ethnicity']
  };
...
IMPORTANT: Validate that percentages in each category sum to 100 before returning!
